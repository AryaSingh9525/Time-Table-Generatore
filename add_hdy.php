...
if (isset($_POST['submit'])) {
    ...
    $dt = $_POST['date'];
    $des = $_POST['desc'];
    $sql = "INSERT INTO `holidays`(`date`, `description`) VALUES ('$dt', '$des')";
...
<div class="animsition" style="top: 180px; position: relative">
    ...
    <div align="center">
        ...
        <form id name="add_fact" method=post action=add_hdy.php class="wrap-form-reservation size22 m-l-r-auto">
                    ...
                    <div class="col-md-4">
                       ...
                       <div class="wrap-input-signup size17 bo2 bo-rad-10 bgwhite pos-relative txt10 m-10">
                            <input style='text-transform:lowercase' class="bo-rad-10 sizefull txt10 p-l-20" type="text"
                                   id="descr" name="desc" oninput="validateAlpha1();" required>
                        </div>
    ...
    <div class="end-footer bg2" style="top: 300px; position: relative">
        <div class="container">
