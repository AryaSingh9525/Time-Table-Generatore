            ...
            <div class="wrap_header trans-0-3">
                ...
                <div class="wrap_menu p-l-45 p-l-0-xl">
                    <nav class="menu">
                        <ul class="main_menu">
                            <li>
                                <a href="./stud_top.php">Home</a>
                            </li>

                            <li>
                                <a href="./check_stud_tt.php">View TT</a>
                            </li>
...
<aside class="sidebar trans-0-4">
    ...
    <ul class="menu-sidebar p-t-95 p-b-70">
        <li class="t-center m-b-13">
            <div class="dropdown">
                <button class="dropbtn"><a style="color: #00ADEF;" href="stud_top.php">HOME</a></button>
            </div>
        </li>

        <li class="t-center m-b-13">
            <div class="dropdown">
                <button class="dropbtn" ><a style="color: #00ADEF;" href="check_stud_tt.php">VIEW TT</a></button>
            </div>
        </li>
