...
if (isset($_POST['faculty'])) {
    ...
    $sql = "UPDATE `faculty_details` SET `rank` = '1' WHERE `fact_id` = '$faculty_id'";
    $sql2 = mysqli_query($conn,"UPDATE login SET level = '1' where username = '$faculty_id'");

    if ($conn->query($sql) === TRUE) {
        $flag = 1;
    } else {
        echo "<script>alert(\"Failed to assign HOD!\");</script>";
    }
...
<div class="animsition">
    ...
    <div align=center style="position: relative; top: 200px">
        ...
        <div>
            <form id="form2" name="form2" method="post" action="assign_hod.php">
                <table>
                    <tr>
                        <td>
                            <!--                            <div class="row">-->
                        ...
                        <td>
                            <div class="wrap-input-signup size17 bo2 bo-rad-10 bgwhite pos-relative txt10 m-10">
                                ...
                                <?php
                                $sql = "SELECT fact_id, f_name FROM faculty_details where rank = '2'";
...
<br/>
        ...
        if ($flag == 1) {
            ...
            <?php
            header("refresh:3;url=assign_hod.php");
        }
        ?>
    </div>
</div>
